...
namespace ARM {
    ...
    public partial class mydbDataSet : global::System.Data.DataSet {
        ...
        public partial class organizationDataTable : global::System.Data.TypedTableBase<organizationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public organizationRow AddorganizationRow(int id, string Name) {
...
namespace ARM.mydbDataSetTableAdapters {
    ...
    public partial class organizationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `organization` WHERE ((`id` = @Original_id) AND ((@IsNull_Name = 1 AN" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `organization` (`id`, `Name`) VALUES (@id, @Name)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `organization` SET `id` = @id, `Name` = @Name WHERE ((`id` = @Original_id)" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ARM.Properties.Settings.Default.mydbConnectionString;
        }
        ...
        public virtual int Fill(mydbDataSet.organizationDataTable dataTable) {
        ...
        public virtual mydbDataSet.organizationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            mydbDataSet.organizationDataTable dataTable = new mydbDataSet.organizationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(mydbDataSet.organizationDataTable dataTable) {
        ...
        public virtual int UpdateAll(mydbDataSet dataSet) {
            ...
            try {
                ...
                if ((this._organizationTableAdapter != null)) {
                    ...
                    this._organizationTableAdapter.Connection = ((global::MySql.Data.MySqlClient.MySqlConnection)(workConnection));
                    this._organizationTableAdapter.Transaction = ((global::MySql.Data.MySqlClient.MySqlTransaction)(workTransaction));
                ...
                if ((this._organizationTableAdapter != null)) {
                    this._organizationTableAdapter.Connection = ((global::MySql.Data.MySqlClient.MySqlConnection)(revertConnections[this._organizationTableAdapter]));
