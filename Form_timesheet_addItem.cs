...
namespace ARM
{
    public partial class Form_timesheet_addItem : Form
    {
        ...
        public void populate_TofWDS()
        {
            var dataSource = m.SelectWDS();
            ...
            dataSource.OrderBy(t => t.Status).ToList();

            this.comboBox4.DataSource = dataSource;
            this.comboBox4.DisplayMember = "Status";
